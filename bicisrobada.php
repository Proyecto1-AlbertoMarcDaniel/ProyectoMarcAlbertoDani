...
<body>
    ...
    <div class="interior100">
        <div class="ajuste"><h2>LISTA DE BICICLETAS ROBADAS<span class="gris"></span></h2></div>
    </div>
...
<?php
            ...
            if(isset($_REQUEST['nom'])){
              //  if($_REQUEST['marca']!=""){
                        $q = "SELECT * FROM anunci WHERE anu_marca LIKE '%$_REQUEST[marca]%' AND anu_ubicacio_robatori LIKE '%$_REQUEST[ubi]%' AND anu_color LIKE '$_REQUEST[color]%' AND anu_titol LIKE '%$_REQUEST[nom]%' AND anu_model LIKE '%$_REQUEST[modelo]%' ORDER BY anu_data_robatori DESC";
              //  } else {
